...
- preview 首屏直接出现 `DEMO CHECKOUT · $0` 和解锁入口；modal 明确无真实扣款。
...
- preview/paywall/full/chart：`src/components/results/result-experience.tsx`、`src/components/results/upgrade-dialog.tsx`
- 浏览器验收：`tests/e2e/funnel.spec.ts`
